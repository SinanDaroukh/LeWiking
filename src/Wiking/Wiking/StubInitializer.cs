...
namespace Wiking
{
    ...
    // Il hérite de l'interface DropCreateDatabaseAlways<>
    // Et introduit les données stubbées à la base de données
    // DropCreateDatabaseIfModelChanges - Mis à jour de la base si changement
    // DropCreateDatabaseAlways - Mis à jour à chaque démarrage
    public class StubInitializer : DropCreateDatabaseIfModelChanges<VikingDBEntities> 
    {
        protected override void Seed(VikingDBEntities context) 
        {
            ...
            //Ajout des données dans leur DbSet<> respectifs.

...
namespace Wiking
{
    public class Manager : IDataManager
    {
        ...
        #endregion
        private IEnumerable<Arme> _lesArmes = GetAllArmes();

        private IEnumerable<Navire> _lesNavires = GetAllNavires();

        private IEnumerable<Divinite> _lesDivinites = GetAllDivinites();
        #region Propriétés
        /// <summary>
        /// Liste de viking
        /// </summary>
        ...
        public IEnumerable<Arme> LesArmes
        {
            get
            {
                return _lesArmes;
        ...
        public IEnumerable<Navire> LesNavires
        {
            get
            {
                return _lesNavires;
        ...
        public IEnumerable<Divinite> LesDivinites
        {
            get
            {
                return _lesDivinites;
            }
        }
